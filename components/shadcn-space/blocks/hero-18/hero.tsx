        ...
        <section ref={sectionRef} className="px-4">
            ...
            >
                ...
                <motion.div variants={itemVariants} className="flex flex-col items-center gap-3 sm:gap-6 py-8 sm:py-11 md:py-20 max-w-2xl mx-auto text-center">
                    ...
                    <p className="text-lg font-normal text-muted-foreground">Design decisions don't happen in isolation. Wooblitz builds your entire storefront, picks the right layout, and gets you ready to take orders — no code, no design skills, no hassle.</p>
